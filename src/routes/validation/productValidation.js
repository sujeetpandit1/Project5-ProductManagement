...
const arrCheck=(value)=>{
  ...
  if (Array.isArray(value)) {
    ...
    if (arr.length === 0) {
        return res.status(400).send({ status: false, message: "Please enter the valid Size within this [\"S\", \"XS\", \"M\", \"X\", \"L\", \"XXL\", \"XL\"]" })
    }
    data[value] = [...arr]
...
module.exports={isValid, isValidBody,isValidString,isValidPhone,isValidEmail,isValidProfileImage,isValidPassword,isValidAddress,isValidPincode,isValidStreet, isValidObjectId ,isValidCity,isValidField, isValidNumber, isValidSize, arrCheck}
